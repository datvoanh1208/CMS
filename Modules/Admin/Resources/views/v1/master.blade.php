...
<!-- Begin page -->
<div id="wrapper">
@include(config('admin.templates.navigation'))
<!-- Start right Content here -->
    <div class="content-page">
        <!-- Start content -->
        <div class="content">
            @include(config('admin.templates.header'))
            <div class="page-content-wrapper ">
                <div class="container-fluid">
                    @include(config('admin.templates.partial'))
                    @yield('content')
                </div><!-- container -->
            </div> <!-- Page content Wrapper -->
        </div> <!-- content -->
        @include(config('admin.templates.footer'))
    </div>
